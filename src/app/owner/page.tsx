                                ...
                                <td className="px-6 py-5 text-right">
                                  <div className="flex justify-end gap-2">
                                    <form action={handleContact}>
                                      ...
                                      <input type="hidden" name="message" value="System-generated follow-up regarding your request." />
                                      <button className="flex items-center gap-1.5 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-[10px] font-black hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900">
